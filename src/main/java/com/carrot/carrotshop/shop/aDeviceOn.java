...
@ConfigSerializable
public class aDeviceOn extends Shop {
	@Setting
	private Location<World> lever;
	@Setting
	private int price;
	
	static private String type = "aDeviceOn";

	public aDeviceOn() {
	}

	public aDeviceOn(Player player, Location<World> sign) throws ExceptionInInitializerError {
		super(sign);
